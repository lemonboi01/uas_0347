...
def home_index():
    ...
    return render_template("client/dashboard.html", total_user=len(users))

@app.route("/users")
@login_required
def user_index():
    users = UserModel.query.all()
    return render_template("client/user.html", users=users)

@app.route("/users/create")
@login_required
def user_add():
    return render_template("client/form.html", card_title="Add User")
...
def user_edit(id):
    ...
    return render_template("client/form.html", card_title="Edit User", user=user)
